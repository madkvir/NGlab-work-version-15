export const translations = {
  ...
  es: {
    forDealership: 'Para Concesionarios',
    coming: 'Próximo',
...
export const pricingTranslations = {
  en: {
    ...
    platform: {
      ...
      subtitle: "Full Suite of AI Tools",
      period: "Monthly",
      price: "€499",
      features: [
    ...
    trial: {
      ...
      description: "Get 500 tokens to test our platform's capabilities with no commitment",
      cta: "Try for Free"
    }
  },
  de: {
    ...
    customDev: {
      ...
      features: [
        ...
        "Implementierung individueller Geschäftslogik",
        "Individuelle Integrationen und API-Entwicklung"
      ],
      cta: "Vertrieb kontaktieren"
    },
    platform: {
      title: "Plattformzugang",
      subtitle: "Komplettes KI-Toolset",
      period: "Monatlich",
      price: "€499",
      features: [
        "Zugang zu allen Plattformfunktionen",
        "Unbegrenzte KI-Generationen",
    ...
    trial: {
      ...
      description: "Erhalten Sie 500 Tokens zum Testen unserer Plattform ohne Verpflichtung",
  ...
  es: {
    ...
    platform: {
      ...
      subtitle: "Set completo de herramientas de IA",
      period: "Mensual",
      price: "€499",
      features: [
    ...
    trial: {
      ...
      description: "Obtenga 500 tokens para probar nuestra plataforma sin compromiso",
      cta: "Probar Gratis"
    }
  },
  ru: {
    ...
    platform: {
      ...
      subtitle: "Полный набор ИИ-инструментов",
      period: "Ежемесячно",
      price: "€499",
      features: [
        "Доступ ко всем функциям платформы",
        "Безлимитная генерация ИИ",
  ...
  ua: {
    ...
    customDev: {
      ...
      features: [
        ...
        "Реалізація унікальної бізнес-логіки",
        "Індивідуальні інтеграції та розробка API"
      ],
      cta: "Відділ продажів"
    },
    platform: {
      title: "Доступ до платформи",
      subtitle: "Повний набір ШІ-інструментів",
      period: "Щомісячно",
      price: "€499",
      features: [
        "Доступ до всіх функцій платформи",
        "Безлімітна генерація ШІ",
        "Всі інтеграції включені",
        "Пріоритетна підтримка"
      ],
      cta: "Почати"
    },
    trial: {
      title: "Почати безкоштовний період",
      description: "Отримайте 500 токенів для тестування нашої платформи без зобов'язань",
    ...
    faqs: [
      {
        ...
        answer: "NeuroGen Lab ist eine KI-gestützte Plattform, die Unternehmen dabei hilft, ihre Abläufe durch fortschrittliche künstliche Intelligenz zu automatisieren und zu verbessern. Unser System verwendet modernste Machine-Learning-Algorithmen, um Ihre Geschäftsdaten zu verstehen und zu verarbeiten und bietet intelligente Automatisierung und Erkenntnisse."
      },
      {
        question: "Welche Unternehmen können von NeuroGen Lab profitieren?",
        answer: "NeuroGen Lab wurde entwickelt, um Unternehmen aller Größen in verschiedenen Branchen zu unterstützen. Ob kleines Start-up oder großes Unternehmen, unsere KI-Lösungen können an Ihre spezifischen Anforderungen in den Bereichen Kundenservice, Datenanalyse, Content-Generierung und mehr angepasst werden."
      },
      {
        question: "Wie lange dauert die Implementierung der Lösung?",
        answer: "Die Implementierungszeit hängt von Ihren spezifischen Anforderungen und der Komplexität der Integration ab. Typischerweise kann die grundlegende Einrichtung innerhalb weniger Tage abgeschlossen werden, während komplexere kundenspezifische Lösungen mehrere Wochen in Anspruch nehmen können. Unser Team unterstützt Sie während des gesamten Prozesses."
      },
      {
        question: "Sind meine Daten bei NeuroGen Lab sicher?",
        answer: "Ja, wir nehmen Datensicherheit sehr ernst. Wir verwenden branchenübliche Verschlüsselungsprotokolle, regelmäßige Sicherheitsaudits und strenge Datenverarbeitungsverfahren. Alle Daten werden in Übereinstimmung mit der DSGVO und anderen relevanten Datenschutzbestimmungen verarbeitet."
      },
      {
        question: "Welche Art von Support bieten Sie an?",
        answer: "Wir bieten umfassenden Support, einschließlich 24/7 technischer Unterstützung, dedizierte Account Manager, detaillierte Dokumentation und regelmäßige Schulungen. Unser Team steht Ihnen jederzeit zur Verfügung, um Sie bei der Maximierung der Vorteile unserer KI-Lösungen zu unterstützen."
      },
      {
        question: "Ist NeuroGen Lab in mehreren Sprachen verfügbar?",
        answer: "Ja, unsere Plattform unterstützt mehrere Sprachen und kann an verschiedene regionale Anforderungen angepasst werden. Kontaktieren Sie unser Vertriebsteam für spezifische Sprachverfügbarkeit und Anpassungsoptionen."
      }
    ]
  },
  es: {
    ...
    faqs: [
      {
        ...
        answer: "NeuroGen Lab es una plataforma impulsada por IA que ayuda a las empresas a automatizar y mejorar sus operaciones a través de la inteligencia artificial avanzada. Nuestro sistema utiliza algoritmos de aprendizaje automático de última generación para comprender y procesar los datos de su empresa, proporcionando automatización e información inteligente."
      },
      {
        question: "¿Qué tipo de empresas pueden beneficiarse de NeuroGen Lab?",
        answer: "NeuroGen Lab está diseñado para ayudar a empresas de todos los tamaños en diversas industrias. Ya sea una pequeña startup o una gran empresa, nuestras soluciones de IA se pueden personalizar para satisfacer sus necesidades específicas en servicio al cliente, análisis de datos, generación de contenido y más."
      },
      {
        question: "¿Cuánto tiempo toma implementar la solución?",
        answer: "El tiempo de implementación varía según sus necesidades específicas y la complejidad de la integración. Típicamente, la configuración básica se puede completar en unos días, mientras que las soluciones personalizadas más complejas pueden tomar varias semanas. Nuestro equipo brinda soporte durante todo el proceso."
      },
      {
        question: "¿Están seguros mis datos con NeuroGen Lab?",
        answer: "Sí, nos tomamos muy en serio la seguridad de los datos. Empleamos protocolos de cifrado estándar de la industria, auditorías de seguridad regulares y procedimientos estrictos de manejo de datos. Todos los datos se procesan en cumplimiento con el GDPR y otras regulaciones relevantes de protección de datos."
      },
      {
        question: "¿Qué tipo de soporte proporcionan?",
        answer: "Ofrecemos soporte integral que incluye asistencia técnica 24/7, gerentes de cuenta dedicados, documentación detallada y sesiones de capacitación regulares. Nuestro equipo siempre está disponible para ayudarlo a maximizar los beneficios de nuestras soluciones de IA."
      },
      {
        question: "¿Está NeuroGen Lab disponible en varios idiomas?",
        answer: "Sí, nuestra plataforma admite varios idiomas y se puede personalizar para diferentes requisitos regionales. Contacte a nuestro equipo de ventas para conocer la disponibilidad de idiomas específicos y opciones de personalización."
      }
    ]
  },
  ru: {
    ...
    faqs: [
      {
        ...
        answer: "NeuroGen Lab - это платформа на базе ИИ, которая помогает бизнесу автоматизировать и улучшать свою работу с помощью передового искусственного интеллекта. Наша система использует современные алгоритмы машинного обучения для понимания и обработки ваших бизнес-данных, обеспечивая интеллектуальную автоматизацию и аналитику."
      },
      {
        question: "Каким компаниям подходит NeuroGen Lab?",
        answer: "NeuroGen Lab создан для помощи бизнесу любого размера в различных отраслях. Будь то небольшой стартап или крупное предприятие, наши ИИ-решения могут быть настроены под ваши конкретные потребности в обслуживании клиентов, анализе данных, генерации контента и многом другом."
      },
      {
        question: "Сколько времени занимает внедрение решения?",
        answer: "Время внедрения зависит от ваших конкретных потребностей и сложности интеграции. Обычно базовая настройка может быть завершена в течение нескольких дней, в то время как более сложные индивидуальные решения могут занять несколько недель. Наша команда обеспечивает поддержку на протяжении всего процесса."
      },
      {
        question: "Безопасны ли мои данные с NeuroGen Lab?",
        answer: "Да, мы очень серьезно относимся к безопасности данных. Мы используем отраслевые стандарты шифрования, регулярные проверки безопасности и строгие процедуры обработки данных. Все данные обрабатываются в соответствии с GDPR и другими соответствующими нормами защиты данных."
      },
      {
      ...
      },
      {
        ...
        answer: "Да, наша платформа поддерживает несколько языков и может быть настроена под различные региональные требования. Свяжитесь с нашей командой продаж для уточнения доступности конкретных языков и вариантов настройки."
      }
    ]
  },
  ua: {
    ...
    faqs: [
      {
        ...
        answer: "NeuroGen Lab - це платформа на базі ШІ, яка допомагає бізнесу автоматизувати та покращувати свою роботу за допомогою передового штучного інтелекту. Наша система використовує сучасні алгоритми машинного навчання для розуміння та обробки ваших бізнес-даних, забезпечуючи інтелектуальну автоматизацію та аналітику."
      },
      {
        question: "Яким компаніям підходить NeuroGen Lab?",
        answer: "NeuroGen Lab створений для допомоги бізнесу будь-якого розміру в різних галузях. Будь то невеликий стартап чи велике підприємство, наші ШІ-рішення можуть бути налаштовані під ваші конкретні потреби в обслуговуванні клієнтів, аналізі даних, генерації контенту та багато іншого."
      },
      {
        question: "Скільки часу займає впровадження рішення?",
        answer: "Час впровадження залежить від ваших конкретних потреб та складності інтеграції. Зазвичай базове налаштування може бути завершено протягом кількох днів, тоді як більш складні індивідуальні рішення можуть зайняти кілька тижнів. Наша команда забезпечує підтримку протягом всього процесу."
      },
      {
        question: "Чи безпечні мої дані з NeuroGen Lab?",
        answer: "Так, ми дуже серйозно ставимося до безпеки даних. Ми використовуємо галузеві стандарти шифрування, регулярні перевірки безпеки та суворі процедури обробки даних. Всі дані обробляються відповідно до GDPR та інших відповідних норм захисту даних."
      },
      {
        question: "Яку підтримку ви надаєте?",
        answer: "Ми пропонуємо комплексну підтримку, включаючи технічну допомогу 24/7, виділених менеджерів по роботі з клієнтами, детальну документацію та регулярні навчальні сесії. Наша команда завжди готова допомогти вам максимально ефективно використовувати наші ШІ-рішення."
      },
      {
        question: "Чи доступний NeuroGen Lab різними мовами?",
        answer: "Так, наша платформа підтримує кілька мов і може бути налаштована під різні регіональні вимоги. Зв'яжіться з нашою командою продажів для уточнення доступності конкретних мов та варіантів налаштування."
      }
    ]
  }
};
