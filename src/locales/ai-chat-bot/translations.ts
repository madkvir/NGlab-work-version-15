export const aiChatBotTranslations = {
  ...
  de: {
    title: "KI-Chatbot",
    description: "Verbessern Sie Ihren Kundenservice mit unserer intelligenten Chatbot-Lösung, die 24/7-Support und nahtlose Kundeninteraktionen bietet.",
    sectionTitles: {
    ...
    contactBlock: {
      title: "Benötigen Sie weitere Informationen?",
      description: "Kontaktieren Sie unser Vertriebsteam, um mehr darüber zu erfahren, wie unser KI-Chatbot Ihrem Unternehmen helfen kann.",
    ...
    articleContent: {
      ...
      industries: [
        ...
        },
        {
          icon: "🎓",
          name: "Bildung",
          description: "Unterstützung von Studenten mit Kursinformationen und akademischer Beratung."
        },
        {
          icon: "🛒",
          name: "E-Commerce",
          description: "Steigerung der Konversionen durch sofortige Echtzeit-Unterstützung."
        },
        {
          icon: "💼",
          name: "Finanzen",
        ...
        },
        {
          ...
          content: {
            ...
            list: [
              ...
              "Erfassung von Leads und Kontaktinformationen für Ihr Vertriebsteam"
            ]
          }
        },
        {
          ...
          content: {
            ...
            list: [
              "Schnelle Verarbeitung von Anfragen, auch in Spitzenzeiten",
              "Effektive Arbeit für Unternehmen jeder Größe",
              "Nahtlose Bewältigung großer Veranstaltungen"
            ]
          }
        },
        {
          ...
          content: {
            ...
            list: [
              "Gewährleistung konsistenter und präziser Antworten über alle Kanäle",
              "Mehrsprachige Unterstützung für globale Kundenbasis",
              "Beibehaltung des Gesprächskontexts für natürlichere Interaktionen"
            ]
          }
        }
      ],
