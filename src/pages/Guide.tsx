...
const Guide = () => {
  ...
  const seoData = {
    ...
    keywords: "AI guide, user manual, getting started, AI implementation, best practices, neural networks, machine learning tutorial, AI optimization",
    ogTitle: "Complete User Guide for NeuroGen Lab AI Solutions",
    ogDescription: "Step-by-step instructions and comprehensive guidance for implementing and optimizing AI solutions with NeuroGen Lab. From basics to advanced features.",
    ogImage: "",
    ogUrl: "https://neurogenlab.de/guide",
    twitterTitle: "NeuroGen Lab User Guide: Master AI Implementation",
    twitterDescription: "Learn how to effectively implement and optimize AI solutions with our comprehensive user guide. Expert tips and best practices included.",
    twitterImage: "",
    author: "NeuroGen Lab Technical Team",
