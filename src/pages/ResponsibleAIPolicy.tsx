...
const ResponsibleAIPolicy = () => {
  ...
  const seoData = {
    ...
    description: "Learn about NeuroGen Lab's commitment to responsible AI development and usage. Our comprehensive policy on ethical AI implementation, user rights, and AI governance standards.",
    keywords: "responsible AI, ethical AI, AI policy, artificial intelligence guidelines, AI governance, AI ethics, machine learning ethics, AI compliance, AI safety",
    ogTitle: "Responsible AI Policy | NeuroGen Lab - Ethical AI Development Guidelines",
    ogDescription: "Discover our comprehensive approach to responsible AI development and implementation. Learn about our ethical guidelines, user protections, and commitment to AI safety.",
    ogUrl: "https://neurogenlab.de/responsible-ai-policy",
    ogImage: "",
    twitterTitle: "NeuroGen Lab's Responsible AI Policy - Ethical AI Development",
    twitterDescription: "Our commitment to ethical AI development and implementation. Comprehensive guidelines ensuring responsible AI usage and user protection.",
    twitterImage: "",
    author: "NeuroGen Lab AI Ethics Committee",
      ...
      content: (
        <div>
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>Sell or resell the Services in any manner inconsistent with any applicable laws or regulations.</li>
          </ul>
        </div>
      )
    },
    {
      ...
      content: (
        <div>
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>Engage in any use, including modification, copying, redistribution, publication, display, performance, or retransmission, of any portions of any Services, other than as expressly permitted by this Policy, without the prior written consent of NeuroGen Lab, which consent NeuroGen Lab may grant or refuse in its sole and absolute discretion.</li>
      ...
      content: (
        <div>
          ...
          <ul className="list-disc pl-6 mb-4">
            ...
            <li>Not compile facial recognition databases through targeted scraping of facial images from the internet, social media, or CCTV footage, unless it is part of a legally compliant and narrowly defined purpose.</li>
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p>
            <strong>Email:</strong> <a href="mailto:office@neurogenlab.de" className="text-emerald-400 hover:underline">office@neurogenlab.de</a>
          </p>
        </div>
      )
    }
      ...
      <main className="pt-24 pb-16">
        ...
        <div className="mt-8"> <BackToHome /> </div>
          ...
          <div className="text-gray-300 mb-8 space-y-4">
            ...
            <p>
              This Responsible AI Policy ("Policy") is part of our Terms of Service ("Legal Terms") and should therefore be read alongside our main Legal Terms: https://autohaus.neurogenlab.de/terms. When you use the AI-powered services provided by NeuroGen Lab ("AI Products"), you warrant that you will comply with this document, our Legal Terms and all applicable laws and regulations governing AI. Your usage of our AI Products signifies your agreement to engage with our platform in a lawful, ethical, and responsible manner that respects the rights and dignity of all individuals. If you do not agree with these Legal Terms, please refrain from using our Services. Your continued use of our Services implies acceptance of these Legal Terms.
            </p>
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>(c) responsible implementation and management of AI Products within our Services</li>
            </ul>

            <h2 className="text-xl font-bold text-emerald-400 mb-4">WHO WE ARE</h2>
            
            <p>
              We are NeuroGen Lab, doing business as NGLab ("Company," "we," "us," or "our") a company registered in Germany at Gartenweg 2, Oranienburg 16515. We operate the website https://neurogenlab.de (the "Site"), as well as any other related products and services that refer or link to this Policy (collectively, the "Services").
            </p>
          </div>
