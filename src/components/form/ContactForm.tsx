...
const formTranslations = {
  ...
  de: {
    ...
    message: "Nachricht",
    consent: "Ich stimme der Verarbeitung meiner persönlichen Daten gemäß der",
    privacyPolicy: "Datenschutzerklärung",
    success: {
      title: "Nachricht erfolgreich gesendet!",
      description: "Vielen Dank für Ihre Kontaktaufnahme. Wir werden uns schnellstmöglich bei Ihnen melden."
    }
  },
  es: {
    firstName: "Su Nombre *",
    ...
    message: "Mensaje",
    consent: "Acepto el procesamiento de mis datos personales de acuerdo con la",
