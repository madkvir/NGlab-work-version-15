    ...
    content: (
      <div>
        ...
        <p className="mb-4">
          ...
          cart reminders (depending on your settings). The third parties and service providers use
          their technology to provide advertising about products and services tailored to your
          interests which you may see on our Services or on other websites.
        </p>
        <p className="mb-4">
    ...
    content: (
      <div>
        ...
        <p className="mb-4">
          ...
          YOUR PERSONAL INFORMATION?". You must use the AI Products in any way that violates the
    ...
    content: (
      <div>
        ...
        <p className="mb-4">
          ...
          SHARE YOUR PERSONAL INFORMATION?" above), in Ukraine, United States, and other countries.
        </p>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          European Commission's Standard Contractual Clauses for transfers of information between
          our group companies and between us and our third-party providers. These clauses require
          all recipients to protect all personal information that they process originating from the
          EEA or UK in accordance with European data protection laws and regulations. Our Data
          Processing Agreements that include Standard Contractual Clauses are available here:{" "}
        ...
        <p className="mb-4">
          These include a set of Binding Corporate Rules ("BCRs") established and implemented by us.
          Our BCRs have been recognized by EEA and UK data protection authorities as providing an
          adequate level of protection to the personal information we process internationally. You
          can find a copy of our BCRs here:{" "}
          <a
    ...
    content: (
      <div>
        ...
        <p className="mb-4">
          ...
          contact us at office@neurogenlab.de.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div>
        <p className="mb-4">
          ...
          United Kingdom (UK), and Switzerland, you have rights that allow you greater access to and
        ...
        <p className="mb-4">
          ...
          details provided in the section "HOW CAN YOU CONTACT US ABOUT THIS NOTICE?" below. You
          will then be removed from the marketing lists. However, we may still communicate with you
          — for example, to send you service-related notices that are necessary for the
