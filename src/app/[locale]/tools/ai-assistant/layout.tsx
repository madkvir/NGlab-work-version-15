...
export const metadata = generatePageMetadata(
  'tools/ai-assistant',
  'AI Assistant | NeuroGen Lab - Intelligent Automation',
  'Transform your business with AI-powered assistant technology. Intelligent automation, smart workflows, and enhanced productivity solutions.',
  `${baseUrl}/assets/images/og-ai-assistant.jpg`,
  'NeuroGen Lab AI Assistant'
);
