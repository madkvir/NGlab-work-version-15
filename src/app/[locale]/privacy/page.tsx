      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            ...
            payment instrument. All payment data is handled and stored by Stripe. You may find their
            privacy notice link(s) here:{" "}
            <a href="https://stripe.com/en-de/privacy" className="text-emerald-400 hover:underline">
          ...
          <p className="mb-4">
            ...
            social media provider, as described in the section called "HOW DO WE HANDLE YOUR SOCIAL
            LOGINS?" below.
          </p>
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              ...
              your device's location, which can be either precise or imprecise. How much information
        ...
        <div>
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              ...
              including providing our Services or at your request prior to entering into a contract
              with you.
            </li>
            <li>
              <strong>Legal Obligations.</strong> We may process your information where we believe
              it is necessary for compliance with our legal obligations, such as to cooperate with a
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            ...
            ("third parties") who perform services for us or on our behalf and require access to
            such information to do that work. We have contracts in place with our third parties,
            which are designed to help safeguard your personal information. This means that they
            cannot do anything with your personal information unless we have instructed them to do
            it. They will also not share your personal information with any organization apart from
          ...
          <ul className="list-disc list-inside mb-4">
            ...
            <li>
              ...
              interact with public areas of the Services, such personal information may be viewed by
              all users and may be publicly made available outside the Services in perpetuity. If
              you interact with other users of our Services and register for our Services through a
              social network (such as Facebook), your contacts on the social network will see your
              name, profile photo, and descriptions of your activity. Similarly, other users will be
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            ...
            shopping cart reminders (depending on your settings). The third parties and service
            providers use their technology to provide advertising about products and services
            tailored to your interests which you may see on our Services or on other websites.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            with Google Analytics, Google Analytics Demographics and Interests Reporting and Google
            Display Network Impressions Reporting. To opt out of being tracked by Google Analytics
            ...
            <a href="https://adssettings.google.com/" className="text-emerald-400 hover:underline">
              {" "}
              Ads Settings
            </a>{" "}
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            ...
            Providers"), including OpenAI. As outlined in this Privacy Notice, your input, output,
            and personal information will be shared with and processed by these AI Service Providers
            to enable your use of our AI Products for purposes outlined in "WHAT LEGAL BASES DO WE
            RELY ON TO PROCESS YOUR PERSONAL INFORMATION?". You must use the AI Products in any way
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            ...
            media account details (like your Facebook or X account). Where you choose to do this, we
          ...
          <p className="mb-4">
            ...
            Privacy Notice or that are otherwise made clear to you in the relevant Services. Please
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            Our servers are located in Ukraine and United States. If you are accessing our Services
            from outside Ukraine and United States, please be aware that your information may be
            transferred to, stored by, and processed by us in our facilities and by those third
            parties with whom we may share your personal information (see "WHEN AND WITH WHOM DO WE
            SHARE YOUR PERSONAL INFORMATION?" above), in Ukraine, United States, and other
            countries.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            the European Commission's Standard Contractual Clauses for transfers of information
            ...
            Data Processing Agreements that include Standard Contractual Clauses are available here:{" "}
            <a href="https://keepincrm.com/privacy" className="text-emerald-400 hover:underline">
              https://keepincrm.com/privacy
            </a>
          ...
          <p className="mb-4">
            These include a set of Binding Corporate Rules ("BCRs") established and implemented by
            us. Our BCRs have been recognized by EEA and UK data protection authorities as providing
            an adequate level of protection to the personal information we process internationally.
            You can find a copy of our BCRs here:{" "}
            <a
              href="https://keepincrm.com/contract-offer"
              className="text-emerald-400 hover:underline"
            >
              https://keepincrm.com/contract-offer
            </a>
            .
          </p>
        </div>
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            ...
            (iii) to restrict the processing of your personal information; (iv) if applicable, to
          ...
          <p className="mb-4">
            ...
            right to withdraw your consent at any time. You can withdraw your consent at any time by
          ...
          <p className="mb-4">
            ...
            with you — for example, to send you service-related notices that are necessary for the
      ...
      content: (
        <div>
          <p className="mb-4">
            ...
            office@neurogenlab.de or contact us by post at:
          </p>
          <p className="mb-4">
            NeuroGen Lab
            <br />
      ...
      content: (
        <div>
          <p className="mb-4">
            ...
            may be limited in some circumstances by applicable law. To request to review, update, or
