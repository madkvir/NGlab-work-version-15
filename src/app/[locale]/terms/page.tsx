  ...
  const sections = [
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            ...
            intellectual property rights in such Submissions. You agree that we shall own this
          ...
          <ul className="list-disc pl-6 mb-4">
            <li>
              Confirm that you have read and agree to our "PROHIBITED ACTIVITIES" and will not post,
    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            We offer a 14-day free trial or 1000 Tokens (USAGE) to new users who register with the
            Services. The account will not be charged and the subscription will be suspended until
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-4">
            The Services do not offer users to submit or post content. We may provide you with the
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            ...
            contacts who have also registered to use the Services. You can deactivate the connection
      ...
      content: (
        <div>
          <p className="mb-4">
            ...
            United States, Ukraine, and United Kingdom. If you access the Services from any other
            region of the world with laws or other requirements governing personal data collection,
            use, or disclosure that differ from applicable laws in the United States, Ukraine, and
            United Kingdom, then through your continued use of the Services, you are transferring
            your data to the United States, Ukraine, and United Kingdom, and you expressly consent
            to have your data transferred to and processed in the United States, Ukraine, and United
            Kingdom.
          </p>
        </div>
      ),
    ...
    },
    {
      ...
      content: (
        <div>
          <p className="mb-4">
            These Legal Terms are governed by and interpreted following the laws of Germany, and the
            use of the United Nations Convention on Contracts for the International Sales of Goods
            is expressly excluded. If your habitual residence is in the EU, and you are a consumer,
            you additionally possess the protection provided to you by obligatory provisions of the
            law in your country of residence. NeuroGen Lab and yourself both agree to submit to the
            non-exclusive jurisdiction of the courts of Oranienburg, which means that you may make a
      ...
      content: (
        <div>
          ...
          <p className="mb-4">
            ...
            European Centre of Arbitration having its seat in Strasbourg, and who are in force at
            the time the application for arbitration is filed, and of which adoption of this clause
            constitutes acceptance. The seat of arbitration shall be Oranienburg, Germany. The
            language of the proceedings shall be Deutsch. Application of substantive law shall be
            the law of Germany.
          </p>
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-gray-300 mb-8 space-y-4">
            ...
            <p>
              You can contact us by email at office@neurogenlab.de or by mail to Gartenweg 2,
              Oranienburg 16515, Germany.
            </p>

            <p>
              These Legal Terms constitute a legally binding agreement made between you, whether
              personally or on behalf of an entity ("you"), and NeuroGen Lab, concerning your access
